    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="index.php" class="nav-item nav-link active "><i class="ri-graduation-cap-fill me-2"></i>Student</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Total Deactive</p>
                                <h6 class="mb-0"><?php 
                                   include("../connection.php");

                                $sql = "SELECT COUNT(*) as total FROM student WHERE status = 'deactive'";
                                $result = mysqli_query($conn,$sql);
...
while ($data = mysqli_fetch_array($result)) {
    ...
    <tr>
        <td>{$data['id']}</td>
        <td><img src='{$data['image']}' height='100vh' width='80vw' alt='not work'></td>
        ...
        <td>{$data['password']}</td>
        <td>{$data['status']}</td>
        <td><a class='p-4' href='update2.php?id={$data['id']}'><i class='ri-loop-left-line'></i></a></td>
        <td><a class='p-4' href='delete2.php?id={$data['id']}'><i class='ri-close-circle-fill'></i></a></td>
        <td><a class='p-4' href='download2.php?id={$data['id']}'><i class='ri-download-line'></i></a></td>
    </tr>
    ";
}
