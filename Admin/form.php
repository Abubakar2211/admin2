        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="form.php" class="nav-item nav-link active"><i class="ri-login-circle-line me-2"></i>Sign up</a>
        ...
        <div class="content">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "INSERT INTO `users` (`image`, `category`, `name`,`phone`, `email`, `password`,`status`) VALUES ('$image_path', '$category','$name', '$phone', '$email', '$password','$status')";
