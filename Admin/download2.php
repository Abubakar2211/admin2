...
if (isset($_GET['id'])) {
    ...
    $show = mysqli_query($conn, $sql) or die("Failed");
    $result = mysqli_fetch_assoc($show);

    echo '<div class="container mt-3">
        <h2>Your Card ' . $result['student_name'] . '</h2>
        <br>
        <div class="card" style="width:400px">
            <img class="card-img-top" src="' . $result['image'] . '" alt="Card image" style="width:100%">
            <div class="card-body text-center">
                <h5 class="card-title">Student id: ' . $result['student_id'] . '</h5>
                <h5 class="card-title">Name :' . $result['student_name'] . '</h5>
                <h5 class="card-title">father_name :' . $result['father_name'] . '</h5>
                <h5 class="card-title">Batch code : ' . $result['batch_code'] . '</h5>
                <h5 class="card-title">Contact number :' . $result['phone'] . '</h5>
