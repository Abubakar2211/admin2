                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                $sql = "SELECT COUNT(*) as total FROM users WHERE status = 'deactive'";
                                $result = mysqli_query($conn,$sql);
...
while ($data = mysqli_fetch_array($result)) {
    ...
    <tr>
        ...
        <td>{$data['password']}</td>
        <td>{$data['status']}</td>
        <td><a class='p-4' href='update.php?id={$data['id']}'><i class='ri-loop-left-line' ></i></a></td>
        <td><a class='p-4' href='delete.php?id={$data['id']}'><i class='ri-close-circle-fill '></i></a></td>
        <td><a class='p-4' href='download.php?id={$data['id']}'><i class='ri-download-line'></i></a></td>
    </tr>
    ";
}
