...
if(isset($_POST['submit'])){
    ...
    $update = "UPDATE `users` SET `category` = '$category',
    `name` = '$name',
    `phone` = '$phone',
    `email` = '$email',
    `password` = '$password',
    ...
    if($check){
        echo"
        <script>alert('Data has been update $ids');window.location='users.php';</script>;
        ";
    }else{
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a  class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Update</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="category" value="<?php echo $result['category']; ?>" class="form-control" id="category">
                                </div>
                                <div class="mb-3">
                                    <label for="name" class="form-label">Name </label>
                                    <input type="text" name="name" value="<?php echo $result['name']; ?>" class="form-control" id="category">
                                </div>                                <div class="mb-3">
                                    <label for="phone" class="form-label">Contact number</label>
                                    <input type="text" name="phone" value="<?php echo $result['phone']; ?>" class="form-control" id="category">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="password" value="<?php echo $result['password']; ?>" class="form-control" id="exampleInputPassword1">
                                </div>
                                <div class="mb-3 ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="myFile" name="image"  value="<?php echo $result['image']; ?>" >
                                </div>
